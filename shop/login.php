...
<DL>
  ...
  <UL>
    ...
    <UL>
      <LI class=user_main_text>角色： </LI>
      <LI class=user_main_input><SELECT id=DropExpiration name=DropExpiration> 
        <OPTION value=None selected>学生</OPTION> 
        <OPTION value=Day>教师</OPTION> 
        <OPTION value=Month>系统管理员</OPTION> 
        </SELECT> </LI></UL></DIV></LI>
  ...
  <UL>
    ...
    <LI class=user_bottom_c><SPAN style="MARGIN-TOP: 40px">如果您尚未在本站注册为用户，请先点此 <A 
    href="http://www.huacker.com.cn">注册</A> 。</SPAN> </LI>
