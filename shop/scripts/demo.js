...
function buy(){
	console.log("buy")
	var cakes = document.getElementById("cakes").getElementsByTagName("tr");
	var items = new Array()
	for(var i = 0; i < cakes.length; i++){
		//console.log(cakes[i].dataset.cakeId)
		
		
		if(cakes[i].getElementsByClassName("checkbox")[0].getElementsByClassName("check-one check")[0].checked){
			items.push({id: cakes[i].getAttribute("cakeid"),quantity:cakes[i].getElementsByClassName("count")[0].getElementsByClassName("count-input")[0].value})
		}
		console.log(items)
	}
	
	var url = "../core/order.inc.php"
	var method = "POST";
	var postData = items;
	var async = true
