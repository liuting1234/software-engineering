...
$cate = $_REQUEST['cate'];
session_start();
$sql="select * from cake_info where cate='{$cate}'";
$rows=fetchAll($sql);
if(!$rows)
{
    $cate="Cheese";
...
<html lang="en">
	...
	<body>
		...
		<div class="meny">
			...
			<h2 ><a style="color:#fff" href="my_order.php"> USER INFO</a></h2>
		</div>
...
<!--login and register 悬浮窗口-->
<script src="../scripts/classie1.js"></script>
		<script src="../scripts/uiMorphingButton_fixed.js"></script>
		<script>
			(function() {
