...
<body>
	<div class="main">
		<img src="/Classroom/img/search/sqxx.png" />
		<h3>
			...
			<table border="1" width="80%">
				...
				<c:forEach items="${userooms}" var="useroom">
					<tr>
						...
						<td><a
							href="/Classroom/admin/chuli?id=${useroom.id}&username=${useroom.username }&result=ty">同意</a></td>
						<td><a
							href="/Classroom/admin/chuli?id=${useroom.id}&username=${useroom.username }&result=bty">不同意</a></td>
					</tr>
				</c:forEach>
			</table>
		</c:if>
