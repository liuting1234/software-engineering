...
if (!defined('TTF_DIR')) {
    if (strstr( PHP_OS, 'WIN') ) {
        ...
        define('TTF_DIR','/home/bstgocom/domains/yygh.84508450.com/public_html/lib/jpgraph/');
    }
}
...
if (!defined('MBTTF_DIR')) {
    if (strstr( PHP_OS, 'WIN') ) {
        ...
        define('MBTTF_DIR','/home/bstgocom/domains/yygh.84508450.com/public_html/lib/jpgraph/');
    }
}
